...
2. What does the blue diamond next to the "last_update" column on the "inventory" table represent? simple attribute, not a key, and because it is filled it is not null

3. How many foreign keys does the "payments" table have? How can you tell? Two, because the diamonds are red
